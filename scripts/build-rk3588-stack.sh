...
git -C "$FFMPEG_DIR" apply "${ROOT_DIR}/patches/0002-ffmpeg-v4l2request-nv15-align64.patch"
grep -q 'V4L2 Request NV15 capture pitch' "${FFMPEG_DIR}/libavutil/hwcontext_v4l2request.c"
(
  cd "$FFMPEG_DIR"
  ./configure \
